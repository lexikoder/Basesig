  ...
  const BasesigUseCases = [
    {
      ...
      description:
        "Basesig uses blockchain-based smart contracts to automate receivables financing workflows, ensuring transparent and tamper-proof agreements between vendors and buyers.",
    },
    {
      icon: Shield,
    ...
    //   description:
    //     "Basesig ensures all participants have real-time visibility of contract status, financing approvals, and payment settlements, reducing disputes and delays.",
    // },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            {/* <p className="text-gray-400 max-w-2xl mx-auto">
              Basesig’s eSignature and document verification layer help Basesig build
